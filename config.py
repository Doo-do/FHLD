...
class Config:
    def __init__(self):
        ...
        self._configs["neg_sampling_rate"] = None
        self._configs["roi_r"] = None
        ...
        self._configs["changeiter"] = 3

    @property
    def changeiter(self):
        return self._configs["changeiter"]
    ...
    @property
    def neg_sampling_rate(self):
        return self._configs["neg_sampling_rate"]

    @property
    def roi_r(self):
        return self._configs["roi_r"]
    ...
    @property
    def snapshot_file_model(self):
        snapshot_file = os.path.join(self.snapshot_dir, self.snapshot_name + "_{}_model.pkl")
        return snapshot_file

    @property
    def snapshot_file_point(self):
        snapshot_file = os.path.join(self.snapshot_dir, self.snapshot_name + "_{}_point.pkl")
        return snapshot_file
